# v2_engine_pbrs_run_20260802_022840

- **Date**: 2026-08-01 19:28 (02:28 UTC 08-02)  **Status**: aborted at RL epoch 1 (~2 games in, no epoch completed, no checkpoints) — infrastructure supersession, user-approved. Diagnosis showed rollout was host-launch-bound (~11 tok/s on A100, GPU 18% idle → projected 50h/$180). Superseded by a restart on infra rev2: fast-path kernels (fla + causal-conv1d, torch 2.12.1+cu129) + batched parallel rollout (4 concurrent games, measured 6-9× aggregate decode scaling). Experiment design unchanged — same config, reward, seed, SFT adapter.
...
- **Results sink**: `gs://llm-mahjong-experiments/v2_engine_pbrs_run_20260802_022840/`; VM auto-shutdown on exit.
...
## Progress
- [2026-08-01 19:28 (02:28 UTC 08-02)] Launched (RL-only, PBRS shaping). Predecessor stopped cleanly after its SFT checkpoint was written; VM kept up; monitor state reset.
...
| gs://llm-mahjong-experiments/v2_engine_pbrs_run_20260802_022840/ | full mirror incl. train_nohup.log |
