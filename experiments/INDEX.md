...
|---|---|---|---|---|
| 2026-08-26 | `exp45_human_bc_prereg` | 人类凤凰卓牌谱 BC 六臂：架构表达力上限直测（修 exp10 教师太弱的方法学漏洞）+ defense_iq 首个非零检验 | 📐 designed（数据管线 4 工作项未开工） | 判据：精度分离≥1pp 且随数据扩大；精度-Elo Spearman；defense_iq≥0.03 |
