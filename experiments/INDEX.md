...
|---|---|---|---|---|
| 2026-08-27 | [exp49_scale_hparam_prereg]（跑批 exp49_20260827_205132） | 顶部平带归因：lr/cosine 直测（大模型超参假设）→ 自动择优 → 100% 数据三臂仲裁 | 🚀 launching | 判据：全量下大臂对 conv Elo ≥+20 → 旗舰易主；平带依旧 → conv 定格、杠杆转 exp46/maka |
