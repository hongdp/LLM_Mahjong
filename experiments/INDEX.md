...
| 2026-08-29 | `exp24f_majsoul_exp49_bc_convformer_20260829_124749`（done） | 雀魂实战：人类 BC 旗舰 conv×v3r×46 长时段运行 | ~9.9 小时 1659 决策，0 新增错误（历史45条来自切换窗口）| ✅ 46 槽动作空间桥接长跑稳定验证；已切换到 exp24g |
| 2026-08-29 | `exp24f_majsoul_exp49_bc_convformer_20260829_124749`（running） | 雀魂实战：人类 BC 旗舰 conv×v3r×46（Elo 池史高 1191.4，非自对弈谱系）；新增 mjai_bridge 46 槽动作空间桥接 | 保真 30 局 416 决策逐位一致（含二次查询立直/杠）；端口 8766（8765 被另一活跃对局占用，未打断） | 🚀 新基建：DnnPolicy 经 action_space.get_space() 透明分发原生/46槽；对局进行中 |
| 2026-08-28 | [exp51_v3r2_prereg]（done，跑批 exp51_20260828_203354） | v3r2（+12 防守理论平面）定型局 + 管线优化（物化缓存 3× 提速） | v3r2 acc 0.8075/Elo 1184.7/defense 0.178——全线平手，未跨晋升线 | **旗舰定格 bc49**；输入编码三重定案=不是杠杆；epoch 20.5→6.9min；31GB 缓存+数据全套上云 |
| 2026-08-28 | [exp50_mortal_import_prereg]（done） | 真 Mortal（298k，maka 平均 S+）经自家 libriichi 黑箱入池 | **1218.6 ± 14.8（9 锚全胜）；旗舰直接对决 p=0.538±0.029、差 +26.7 双法互证；桥 2400+ 局零 fallback** | 北极星差距量化=27±17；数据扩容按缩放曲线即可覆盖；池-人类刻度粗校（1218≈魂天，1052≈C+） |
| 2026-08-27 | [exp49_scale_hparam_prereg]（done） | 平带归因：超参直测 + 100% 数据仲裁 | **超参证伪；数据缩放强兑现（+27~57 Elo）；conv×v3r×46 全量 1191.4 池史新高、防守 0.165；SEres 防守 0.198 新纪录；11M 三度不敌 2M** | 旗舰=conv×v3r×46（2M/56 面/46 槽，+139 vs 纯冠军）；排序随数据反转入 SKILLS；下一杠杆=数据扩容 10 万局级 + exp46 + maka |
| 2026-08-27 | `exp47_arch_factorial_prereg`（跑批 `exp47_factorial_20260827_082805`） | 人类先验谱系第一迭代：trunk×输入×动作空间因子分解，5 臂补齐 exp45 两角点的矩阵 | 🚀 launching | 主判据：简单输入臂（≤v3r）Elo≥1132 且 defense≥0.10 → 谱系旗舰入 exp46 |
| 2026-08-26 | `exp45_human_bc_prereg`（10% 点 done） | 人类凤凰卓牌谱 BC 六臂：表达力直测 + Elo + 防守 | **mortal46 1147.4 / conv 1133.2 全池史上前二（vs 纯冠军 1052）；六臂 defense_iq 全过 0.03（HRF 0.172=纪录 10×）**；2000 局 BC ≥ 2M 局自对弈 RL | H1 结构性成立（参数量 null）；H2 定性成立（+4pp→+90 Elo）；H3 压倒性成立；exp41 判词改写=架构无罪、从零 RL 动力学是被告；副产物：引擎两动作缺口（加杠 4 副露/完成形拒和立直）已修于分支 |
| 2026-08-26 | `exp46_rl_on_prior_prereg`（done） | RL-on-prior：裸 vs KL 锚，各 1M 局自 bc49 | **双臂均低于起点（裸 −143 / 锚 −61 半庄 Elo）；防守侵蚀机制实锤（0.165→0.079 vs 锚保 0.151）** | 生态回归定论：自对弈信号低于先验水平时 RL 净毁值；锚=刹车非发动机；C 臂（三元对手联赛）与离线 RL（exp54 候选）接棒 |
| 2026-08-25 | `exp42_grad_steps_prereg` | 梯度步数假设:batch 4096→1024(步数×4,零复用),基线=exp41-B 998.3 | 🚀 launching | >1020 假设成立、scale 判词重写;≈998 证伪 |
...
| 2026-08-24 | `exp41_mortal_full_prereg`（A/B 两臂） | 完整对齐 Mortal 输入(934 v3)+动作(46)+backbone，从零自对弈 | ❌ A 924.4 / B 998.3 vs 对照 1052.1（纪元5） | **派生牌效特征显著有害 A−B=−73.9（4.8σ）**：喂向听数 ⇒ 贪心最小化向听 ⇒ 副露锁死(95.5%)；纯血臂自学出门清立直(31.6%)更快更强。Mortal 式设计在从零自对弈下不及 2M cnn 冠军配方 |
...
| 2026-08-01 | `v2_engine_pbrs_run_20260802_054918` | exp1 基线：PBRS+REINFORCE，bf16，50×12，central | ⏹ ep26 用户停跑转竞技场：格式100%全程,和牌~62%,风格迁移(立直6.6→3.1,副露49→86) | 竞技场:+1038±1876 不显著;总报告 experiments/reports/report_exp1_shaping_arms_20260802.md |
...
| 2026-08-08 | `exp2_arena_20260808_1050` | exp2 主判据执行：S vs P / S vs 锚 / P vs 锚，各 64 副复式（seed0 同 exp1） | 三场全 null（CI ±1500-1800） | ✅ 完成；报告 experiments/reports/report_exp2_settlement_vs_pbrs_20260809.md |
...
| 2026-08-10 | `exp4_critic_20260810_062927` | exp4 重发（run-1 全损事故后，加固 infra） | critic 机制判据双双不达标（EV 0.020 / 方差降 1%）；**阶梯赛 ep40 vs 锚 +2950, p=0.0027 校正后显著** | ✅ 完成；报告 experiments/reports/report_exp4_critic_20260811.md |
| 2026-08-11 | `exp4_arena_20260811` | exp4 竞技场 6 场：主判据 + ep10/20/30/40/50 阶梯轨迹 | 主判据 null；ep40 首个显著增益 | ✅ 完成；阶梯赛制确立为标准收尾 |
| 2026-08-12 | `exp5_confirm_20260811` | ep40 峰值独立复现（96 副新种子）+ ep35/45/exp2S-ep25 探索 | 主判据未确认（+1093, p=0.076）；**汇总 7 点得 +1076±753, p=0.005，Q=3.58 无异质性** | ✅ 完成；正确图景=平坦 ~+1000 增益；报告 experiments/reports/report_exp5_confirm_20260812.md |
| 2026-08-15 | `dnn_scratch_massive_20260815` / `dnn_ppo_massive_20260815` | 纯自对弈（无教师无塑形）标度曲线 + REINFORCE vs PPO | 和牌率 0.53%→45.8%；PPO-240k vs RF-240k **+1785±473**；标度 +3533 vs +1845 | ✅ 报告 experiments/reports/report_exp8_dnn_scaling_20260815.md |
...
| 2026-08-16 | `elo_league_calib_20260816_144910` | Elo 锚点池校准：7 冻结锚点全循环 21×200 副，双标度联合拟合（设计 experiments/designs/design_elo_league.md） | 排序与全部既有显著结论零冲突；**bc_cnn 竟居全池第 2，仅冠军 E-700k 显著在上（+1072±250）** | ✅ 标尺冻结生效；教师先验价值被低估 → 提议 exp14 BC-warm-start+RL；轻度非传递性 ~800 分已记录 |
...
| 2026-08-29 | exp46C（GCS:exp46C_league，本地仅prereg） | 自我历史联赛生态修复 | 10代零晋升，族内-11平台/族外-52 | 围堵无增益；族内度量盲区发现 |
| 2026-08-29 | exp46Ca（GCS:exp46Ca_oppT0） | 贪心对手降噪 | 终点-27，半庄-107.5 | 降噪加速偏差追逐；方差假设证伪 |
| 2026-08-30 | exp46Cb（GCS:exp46Cb_anchor） | KL锚×贪心对手 | 半庄-23.2(n300)，防守0.188完整 | 最优围堵；bc_kl 0.155失控（无detach） |
| 2026-08-30 | exp46F/G（GCS:exp46F_fixedbc,G_noclamp） | 稳态剥削消融/裁剪归因 | F从未过0.5；G-F=+0.002 | 稳态也不会剥削；裁剪≈空效应→默认移除 |
| 2026-08-30 | exp46H/H2/H3（GCS:exp46H*_*） | 价值预热/detach/熵消融 | H1反噬(trunk拖拽)；H2首个pg负；H3无奖励仍熵胀 | detach=修好优化器；扩散主导熵胀 |
...
| 2026-08-30 | exp56（experiments/exp56_hanchan_ladder_prereg + _20260830_141653）**done** | 半庄刻度向量化 + 纪元 6 榜单重打 + 评分体系 v2 | 向量化半庄 967 场/分（36×，与 batch-1 逐场 uma 完全一致）；I vs bc49 双 T=0 n=4000 **0.5141±0.0079 打平**（克制性判无 z=1.49）；**Mortal 头对头 n=1200/对：与 bc49、exp46I 均打平**（0.477/0.508，pt ±0.5 内）；采样税随强度变号（−109…+191）；复式聚合只吹大 Elo 不增信息；2.2σ 误差棒结案=牌山运气（回放逐字节一致） | 纪元 6 作废，纪元 7 走 v2；北极星「平 Mortal」达成、「超」未达成 |
