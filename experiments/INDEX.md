...
| 2026-08-16 | `dnn_exp16_advclamp_20260816` | 优势裁剪界消融：±5σ cap 掉役满 ~8σ 梯度是否有害（--adv_clamp 10，唯一差异 vs exp15） | 23:45 发射（c5，vit240 同起点），跑至 700k | 🔵 running；主判定=700k vs exp15@700k + 满贯+频率右移；A2 证伪后该问题的新认领 |
