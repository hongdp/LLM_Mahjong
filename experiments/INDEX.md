...
|---|---|---|---|---|
| 2026-08-23 | `dnn_exp27_{A,B,C}_*_20260823`（云 d1–d3）+ `dnn_exp28_{App,Ap}_*_20260823`（本机） | 第一批纪元 3 训练：HandSet 架构三臂 + 熵/温度两臂，各 1.0M 局，K=32 向量化 rollout | A ✅ 1069.2±13.4（=冠军，85 min，$3）；C ✅ 862（配方卡住）；B/A″/A′ 收尾中 | A 成为纪元 3 基线；C 证明大模型需重调配方 |
