...
| 2026-08-23 | `elo_league_calib_epoch3_20260823_023000` | 引擎纪元 3 重校：雀魂单局规则 + 赤宝牌（分支 engine/majsoul-rules），8 锚点全循环 | ⏳ 链式等待纪元 2 重校后启动 | 假设：排序 Spearman ≥ 0.9；所有后续 run 改用 *_r 架构 |
