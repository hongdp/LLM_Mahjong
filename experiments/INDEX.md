...
| 2026-08-23 | `elo_league_calib_epoch2_20260823_003000` | 引擎纪元 2 重校：精确立直暗杠判定（分支 engine/riichi-ankan-exact）触发纪元规则，8 锚点全循环重校 | ⏳ 链式等待 exp22-r2 收尾后启动（预计 03:30–04:30 PDT） | 假设：与纪元 1 各锚点 |Δ|<2σ、排序不变（规则只动 0.014% 决策） |
