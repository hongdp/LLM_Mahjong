...
|---|---|---|---|---|
| 2026-08-01 | `v2_engine_pbrs_run_20260802_054918` | 基线（rev3）：PBRS+REINFORCE，bf16，50×12，central | 🏃 运行中（~17h，GCS+自动关机） | (pending) |
| 2026-08-01 | `v2_engine_ppo_run_20260802_054914` | Arm A（rev3）：PPO 消融，同基线仅换算法，east | 🏃 运行中 | (pending) |
| 2026-08-01 | `v2_engine_ppo_value_run_20260802_054921` | Arm B（rev3）：PPO+价值 bundle，复用 041051 价值 adapter，europe | 🏃 运行中 | (pending) |
