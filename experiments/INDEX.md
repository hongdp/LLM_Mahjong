...
|---|---|---|---|---|
| 2026-08-30 | `exp57_runpod_cost_prereg`（running） | RunPod 性价比裁决：扩展曲线定瓶颈 + 实查目录重算成本表 + 在 pod 实测每核速率 | 目录实查：3090 community 最低价宿主仅 8 vCPU/卡（文档前提 3 被否）；3090 secure 32 核/卡、3090Ti com 28 核/$0.27 | ⏳ 等本地扩展曲线 + ≤$0.6 探针 |
