...
| 2026-08-16 | `dnn_exp11_a1_20260815` / A0=`dnn_exp11_a0_20260815r4` | exp11 三臂受控：A0 普通 critic 基线、A1 价值-距离剖面特权 critic，各 600k 从零 | 两臂均 600k 跑满（A1 终点自对弈 win_rate 0.777）；主判据竞技场待跑（网络中断阻塞 checkpoint 下载） | 🟡 训练完成，判定未出；A2（hazard critic）因 us-central1-b L4 枯竭待换 zone 发射 |
