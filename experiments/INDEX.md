...
|---|---|---|---|---|
| 2026-08-23 | `dnn_exp27_{A,B,C}_*_20260823`（云 d1–d3）+ `dnn_exp28_{App,Ap}_*_20260823`（本机） | 第一批纪元 3 训练：HandSet 架构三臂 + 熵/温度两臂，各 1.0M 局，K=32 向量化 rollout | ⏳ 04:15 发射 | 判据见 exp27/exp28 预注册 |
