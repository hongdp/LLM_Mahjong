...
- **实测（2026-09-08）**：L40S Secure 16 vCPU：稠态 760 局/s（1M 局 82 min 含训练器旧开销；开销修复后预计 ≈25 min ≈ $0.45）。
  **社区 3090 32 vCPU $0.22/h：1,193 局/s ⇒ ≈$0.07/百万局**。训练器逐步 GAE 循环曾占每迭代 7.4 s，已向量化。
